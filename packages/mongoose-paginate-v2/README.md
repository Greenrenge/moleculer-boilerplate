...
```sh
npm install @redex/mongoose-paginate-v2
```
...
const mongoosePaginate = require('@redex/mongoose-paginate-v2');
...
```javascript
var mongoosePaginate = require('@redex/mongoose-paginate-v2');
