...
describe('mongoose-lang', () => {
	...
	test('should throw error require language when it was not sent languages params', () => {
	...
	test('should throw error when type not string', () => {
		const TestSchema = new mongoose.Schema({
			title: {
				type: Object,
				lang: true,
	...
	test('should create title for th, en, ja', async () => {
	...
	test('should return data follow language', async () => {
	...
	test('should return list data follow language', async () => {
